...
<head>
    <meta charset="UTF-8">
    <link href="https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,700;1,700&family=Inter:wght@400;600&family=Outfit:wght@700&family=Noto+Sans+Devanagari:wght@400;700;900&display=swap" rel="stylesheet">
    <style>
        body { margin: 0; padding: 0; background: #f8fafc; color: white; font-family: 'Inter', 'Noto Sans Devanagari', sans-serif; display: flex; justify-content: center; align-items: center; }
        ...
        .quote-icon { font-family: 'Playfair Display', 'Noto Sans Devanagari', serif; font-size: 150px; color: rgba(255,183,3,0.5); line-height: 0; margin-bottom: 60px; }
        .text { font-family: 'Playfair Display', 'Noto Sans Devanagari', serif; font-size: 80px; font-weight: 700; line-height: 1.3; color: #ffffff; }
        .author { font-family: 'Inter', 'Noto Sans Devanagari', sans-serif; font-size: 36px; font-weight: 400; color: #ffb703; margin-top: 50px; text-transform: uppercase; letter-spacing: 4px; }
